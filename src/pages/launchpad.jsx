...
const Launchpad = ({ account, setAccount }) => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto flex min-h-screen flex-col text-white px-14 pb-20">
      ...
      <div className="border border-gray-600 shadow-gray-600 shadow-md h-2/3 p-10 flex justify-between rounded-2xl mt-10">
        <img
          src={rotateImgSrc}
        ...
        <div className="flex flex-col justify-between">
          ...
          <div className="text-right">
            ...
            <div className="text-2xl">
              {mintedNft} / {totalNft} (
              {(100 / parseInt(totalNft)) * parseInt(mintedNft)}%)
            </div>
            <div className="flex flex-col">
              ...
              {myNft <= 1 ? (
                ...
                <Link to={`/Collection`}>
                  <button className="w-full border border-yellow-300 shadow-sm shadow-yellow-600 text-2xl px-5 py-4 mt-8 rounded-xl text-yellow-300 font-bold hover:bg-yellow-300 hover:text-gray-900">
                    Collection 보러가기
                  </button>
                </Link>
              )}
            ...
            <div>
              민팅 후 <span className="text-red-400 font-bold">컬렉션</span>으로
              이동이 가능합니다.
            </div>
          </div>
        </div>
        ...
        {nftMetadata ? (
          <>
            <div className="max-w-[640px]">
              <img
                className="rounded-t-2xl w-[640px] h-[640px]"
